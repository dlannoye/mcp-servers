...
This fork is configured to deploy only the [Time server](src/time) to Azure App Service. See the [Azure deployment instructions](src/time/README.md#azure-app-service-deployment).
